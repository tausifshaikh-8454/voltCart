        ...
        <>
            {
                loader
                    ? <Loader />
                    : error
                        ? (<p className="text-red-500 font-body tab:text-[18px]/[28px] text-[16px]/[26px] font-[300] ">Something went wrong: {error.message}</p>)
                        : (
                            <>
                                <div className="container_layout mx-auto flex justify-center items-center flex-col"  >
                                    ...
                                    <div className=' w-full flex flex-wrap sm:flex-nowrap tab:gap-[30px] gap-[50px]  pb-[50px] ' >
                                        ...
                                        <div className="right_sec w-[100%] md:w-[50%] tab:pr-[20px] pr-0  ">
                                            ...
                                            <ShareComponent shareComp={shareComp} openShareComp={openShareComp} currentLocalShareURL={currentLocalShareURL} prodName={name} />
