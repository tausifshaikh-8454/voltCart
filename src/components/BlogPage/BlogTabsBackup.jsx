...
//                     <BlogCardListing value="Mobil"  />
//                 </Tabs.Content>

//                 <Tabs.Content className="TabsContent  pt-[60px] " value="tablet">
//                     {/* <BlogCardListing value="Tablet" loader={loader} error={error} blogData={blogData} /> */}
//                     <BlogCardListing value="Accessories"  />
//                 </Tabs.Content>
