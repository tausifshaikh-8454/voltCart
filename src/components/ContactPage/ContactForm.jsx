            ...
            >
                ...
                <div className=" tab:w-fit w-full ">
...

                    {
                        toggleMsg &&
                        <div
                            className={` input_msg text-white inline-flex tab:absolute tab:bottom-[5px] right-auto desktop:left-[160px] tab:left-[160px] fixed tab:top-auto top-[30px] left-[50%] tab:translate-x-[0%] translate-x-[-50%] tab:py-[6px] tab:px-[30px] px-[20px] py-[6px] rounded-[6px] justify-center items-center ${succesMsg.additionalClass} `}
                        >
