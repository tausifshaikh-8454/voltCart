...
import spotlightImg from '../../assets/Contact/contact-spotlight.webp'
    ...
    <AnimatePresence mode="wait" >
      ...
      >
        <div className=" w-full max-w-[1440px] m-auto flex justify-end flex-col h-full desktop:px-[50px] tab:px-[30px] px-[20px] tab:pb-[60px] pb-[40px] gt-tab:gap-[70px] gap-[50px] " >
          <div className="texts">
            <h1 className=" uppercase spot_title font-primary tab:text-[18px]/[24px] text-[16px]/[24px] text-white relative z-[99] pl-[10px] " >Contact Us</h1>
            <h3 className=" capitalize font-primary gt-tab:w-[60%] tab:w-[80%] w-full desktop:text-[90px]/[90px] gt-tab:text-[60px]/[60px] tab:text-[55px]/[55px] text-[45px]/[45px] font-[100] text-white mt-[14px] relative z-[99] " >We'd Love to Hear From You</h3>
          </div>
