            ...
            <div
                ...
                <div className="columns cols-1 desktop:w-[50%] gt-tab:w-[50%] tab:w-[45%] w-full flex flex-col gap-[15px] ">
                    ...
                    <div className="socials flex gap-x-[30px] ">
                        <a target="_blank" href="https://api.whatsapp.com/send?phone=8454896170" className=' flex justify-center items-center rounded-[50px] cursor-pointer transition-all ' >
                        ...
                        <a target="_blank" href="https://www.linkedin.com/in/tausif-shaikh-63296018b/" className=' flex justify-center items-center rounded-[50px] cursor-pointer transition-all ' >
