...
const ProductsSpotlight = ({ pageTitle }) => {
      ...
      >
        ...
        <div className=" w-full max-w-[1440px] m-auto flex justify-end flex-col h-full desktop:px-[50px] tab:px-[30px] px-[20px] tab:pb-[60px] pb-[40px] gt-tab:gap-[70px] gap-[50px] " >
          <div className="texts">
            ...
            <h3 className=" capitalize font-primary gt-tab:w-[60%] tab:w-[80%] w-full desktop:text-[90px]/[90px] gt-tab:text-[60px]/[60px] tab:text-[55px]/[55px] text-[45px]/[45px] font-[100] text-white mt-[14px] relative z-[99] " >{pageTitle}</h3>
          </div>
